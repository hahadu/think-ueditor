...
class UeditorConfig
{
    ...
    //    "imageAllowFiles"=> [".png", ".jpg", ".jpeg", ".gif", ".bmp"], /* 上传图片格式显示 */
        ...
        "catcherPath"=> "/upload/images/{yyyy}{mm}{dd}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "videoPath"=> "videos", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "filePath"=> "files", /* 上传保存路径,可以自定义保存路径和文件名格式 */
    ...
    static function config($conf=[]){
        return array_replace_recursive(self::$config,$conf);
    }
